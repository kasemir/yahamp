...
import yahamp.ui.call.QRZCallDisplayPart;

/** JUnit demo of the {@link QRZCallDisplayPart}
 *  @author Kay Kasemir
 */
public class QRZCallDemo
{
    @Test
    public void demoCall()
    {
        ...
        final QRZCallDisplayPart part = new QRZCallDisplayPart();
